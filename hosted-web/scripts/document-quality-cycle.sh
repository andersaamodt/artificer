...
DEFAULT_REGRESSIONS="$SITE_ROOT/tests/fixtures/artificer-document-quality-regressions-v1.tsv"
DEFAULT_HOLDOUT="$SITE_ROOT/tests/fixtures/artificer-document-quality-holdout-v1.tsv"

usage() {
  cat <<'USAGE'
Usage:
  document-quality-cycle.sh run [--profile regressions|holdout] [broad-reasoning-cycle run args...]
  document-quality-cycle.sh transfer [broad-reasoning-cycle transfer args...]

Notes:
  - This is a thin wrapper over broad-reasoning-cycle.sh with document-quality defaults.
